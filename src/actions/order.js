...
function addOrder (order, redirectCallback) {
    ...
    return async function (dispatch) {
        try {
            ...
            const response = await axios.post(`${API_URL}${API_URL_PART}api/order/add`, formData, {
...
function getOrders () {
    return async function (dispatch) {
        try {
            const response = await axios.post(`${API_URL}${API_URL_PART}api/order/get`, {}, {
                headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
            })
...
function getOrdersAll () {
    return async function (dispatch) {
        try {
            const response = await axios.post(`${API_URL}${API_URL_PART}api/order/getAll`, {}, {
                headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
            })
            dispatch(setOrdersAction(response.data))
...
function changeStatusOrder (status, id) {
    return async function (dispatch) {
        try {
            ...
            const response = await axios.post(`${API_URL}${API_URL_PART}api/order/change`, formData, {
                headers: {Authorization: `Bearer ${localStorage.getItem('token')}`}
            })
...
function getOrder (id) {
    return async function (dispatch) {
        try {
            const response = await axios.get(`${API_URL}${API_URL_PART}api/order/get?id=${id}`)
            dispatch(setCurrentOrderAction(response.data))
        } catch(e) {
            alert(e.response.data.message)
        }
